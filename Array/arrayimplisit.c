...
int NbElmt (TabInt T){
    int N = 0;
    while(N<IdxMax && Elmt(T,N+1)!= NilUndef){
        N++;
    }
    if(Elmt(T,N+1)!= NilUndef && N==IdxMax) N++;
    return N;
}
