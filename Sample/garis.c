...
float PanjangGARIS (GARIS L){
	//float res;
	// rumus adalah akar dari kuadrat(selisih absis awal-akhir) + kuadrat(selisih ordinat awal-akhir)
	//res = sqrtf(powf((Ordinat(PAkhir(L))-Ordinat(PAwal(L))),2)+powf((Absis(PAkhir(L))-Absis(PAwal(L))),2));
